...
export function FormLabel(props) {
    return (
        <div className="form-group text-left">
            ...
            <input disabled={props.disabled} type={props.for} id={props.for} name={props.for} className="form-control" placeholder={"Enter a " + props.for} onChange={props.handleChange} />
        </div>
    )
}
